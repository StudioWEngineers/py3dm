...
class Vector3d:
    ...
    @overload
    def __init__(self, x: float, y: float, z: float) -> None: ...
    def __add__(self, value: Vector3d) -> Vector3d: ...
    def __eq__(self, value: object) -> bool: ...
    def __mul__(self, value: float) -> Vector3d: ...
    def __ne__(self, value: object) -> bool: ...
    def __sub__(self, value: Vector3d) -> Vector3d: ...
    def __truediv__(self, value: float) -> Vector3d: ...

    # other methods
    @staticmethod
    def cross_product(vector_a: Vector3d, vector_b: Vector3d) -> Vector3d: ...

    @staticmethod
    def dot_product(vector_a: Vector3d, vector_b: Vector3d) -> float: ...
